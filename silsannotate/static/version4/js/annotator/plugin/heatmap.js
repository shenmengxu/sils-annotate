...
(function() {
  ...
  Annotator.Plugin.Heatmap = (function(_super) {
    ...
    Heatmap.prototype.updateHeatmap = function() {
      ...
      heatmap.enter().append("stop").attr("stop-color", this._colorize(0)).transition().duration(1000).attr("stop-color", (function(_this) {
        return function(p) {
      ...
      heatmap.order().attr("offset", function(p) {
        return p.offset;
      }).transition().duration(250).attr("stop-color", (function(_this) {
        return function(p) {
          return _this._colorize(p.count / max);
        };
      })(this));
