...
Annotator = (function(_super) {
  ...
  window.annotationList = document.createDocumentFragment();
  ...
  Annotator.prototype.setupAnnotation = function(annotation, fireEvents) {
    ...
    //d.innerText = annotation.userId + ": " + annotation.text;
    //annotationList.appendChild(d);
  ...
  Annotator.prototype.loadAnnotations = function(annotations) {
    ...
    loader = function(annList) {
      ...
      if (annList.length > 0) {
        ...
        //CUSTOMIZATION
        //document.getElementById("annotation-list").appendChild(window.annotationList);
        return _this.publish('annotationsLoaded', [clone]);
      }
    };
    clone = annotations.slice();
    if (annotations.length) loader(annotations);
    //console.log("finished loading", window.annotationList);
